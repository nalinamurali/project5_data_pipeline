class SqlQueries:
    ...
    drop_table_list = [drop_staging_events, drop_staging_songs, drop_artists, drop_songs, drop_users, drop_songplays, drop_times]
    ...
    create_table_list = [create_staging_log_table, create_staging_song_table, create_artists_table, create_songs_table, create_users_table, create_songplays_table, create_times_table]
    ...
    COPY_ALL_STAGING_EVENTS_SQL = COPY_SQL.format("staging_events","s3://nali-data-pipeline/log_data/2018/11/2018-11-01-events.json")
